...
$DQL="INSERT INTO `tbl_new`(`New_Id`, `New_Name`, `New_Description`, `New_Price`,`New_Image`)
...
header('location:NewInterface.php');
    ...
    if(isset($_POST['btnDisupdate'])){
        ...
        $Image=$_POST['upload'];
        $update="UPDATE `tbl_new` SET `New_Name`='$DisProductName',`New_Description`='$DisDescription',
