...
$SQL="INSERT INTO `tbl_home`(`Product_Id`, `Product_Name`, `Product_Description`, `Product_Price`, `Product_Image`)
...
header('location:interface.php');
    ...
    if(isset($_POST['btnFTupdate'])){
        ...
        $Image=$_POST['upload'];
        $update="UPDATE `tbl_home` SET `Product_Name`='$UProductName',`Product_Description`='$UpDescription',
