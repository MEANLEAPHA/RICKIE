    ...
    function home(){
        ...
        var imgslider=[
            {'img':'perfume-bottle-table-perfume-widely-used-ensure-pleasant-lasting-smell-is-mixture-substances-such-as-aromatic-essential-oils-alcohol-water-mls_695181-1768.avif',
             ...
             'btnh2':'11$',
             'btncl2':'<button class="purchase2">PURCHASE</button><button class="add2cart2" data-product-id="1" data-product-name="Rose Flower" data-product-price="10.00" data-product-image="photo_2023-09-28_23-08-05.jpg">ADD TO CART</button>'
            },
            {'img':'mockup-black-fragrance-perfume-bottle-mockup-dark-empty-background_795881-1148.jpg',
            'dot':'<i class="fa-solid fa-chess-knight"></i>',
            'btnh2':'12$',
            'btncl2':'<button class="purchase2">PURCHASE</button><button class="add2cart2" data-product-id="2" data-product-name="SunFlower" data-product-price="12.00" data-product-image="photo-1488866022504-f2584929ca5f.avif">ADD TO CART</button>'
            },
            {'img':'best-fragrances-for-men.jpg',
            'dot':'<i class="fa-solid fa-chess-knight"></i>',
            'btnh2':'19$',
            'btncl2':'<button class="purchase2">PURCHASE</button><button class="add2cart2" data-product-id="3" data-product-name="Non Flower" data-product-price="13.00" data-product-image="photo_2024-04-08_21-19-18.jpg">ADD TO CART</button>'
            }
        ];
        ...
        var imgslider3=[
            {'img':'images (1).jpg',
              ...
              'btnh3':'8$',
              'btncl':'<button class="purchase3">PURCHASE</button><button class="add2cart3" data-product-id="4" data-product-name="sexy Flower" data-product-price="45.67" data-product-image="photo_2023-09-28_23-08-05.jpg">ADD TO CART</button>'
            },
            {'img':'images (2).jpg',
             'dot3':'<i class="fa-solid fa-chess-bishop"></i>',
             'btnh3':'12$',
             'btncl':'<button class="purchase3">PURCHASE</button><button class="add2cart3" data-product-id="5" data-product-name="moonFlower" data-product-price="25.80" data-product-image="photo-1488866022504-f2584929ca5f.avif">ADD TO CART</button>'
            },
        
            {'img':'images.jpg',
             'dot3':'<i class="fa-solid fa-chess-bishop"></i>',
             'btnh3':'10$',
             'btncl':'<button class="purchase3">PURCHASE</button><button class="add2cart3" data-product-id="6" data-product-name="goodFlower" data-product-price="19.78" data-product-image="photo_2024-04-06_14-47-29.jpg">ADD TO CART</button>'
            }
        ];
        var show="";
